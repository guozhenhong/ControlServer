...
public:
    ...
    ConcreteAgent* GetConcreteAgent();
private:
    TCPSocket m_TCPListenSocket;
    SocketAddress m_addr;
    EpollEvent m_epollEvent;
    ConcreteAgent *m_pConcreteAgent;
};
...
template <class ConcreteAgent>
ConcreteAgent* TCPListenAgent<ConcreteAgent>::GetConcreteAgent()
{
    return m_pConcreteAgent;
}
